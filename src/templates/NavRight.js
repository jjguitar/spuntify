...
const NavRight = () => {
  ...
  <div class="container__nav-right">
    ...
    <ul class="nav-right__home">
      <li class="gray__push"><img src="${home}" class="icon__home">Home</li>
    ...
    <ul class="nav-right__create-playlist">
      <li><img src="${plus}" class="icon__home plus">Create Playlist</li>
      <li><img src="${heart}" class="icon__home heart">Liked Songs</li>
    </ul>
